        ...
        <div className="flex space-x-4">
          ...
          <div className="flex flex-col space-y-1">
            ...
            <span className="text-xs dark:text-gray-600">
              {details.dateTime.slice(0, 16)}
            </span>
          </div>
        </div>
        <div>
          <img
            src={details.product_img_URl}
            alt=""
            className="object-cover w-full mb-4 h-full dark:bg-gray-500"
          />
          <h2 className="mb-1 text-xl font-semibold">{details.query_title}</h2>
          <p className="text-sm dark:text-gray-600">{details.description}</p>
        </div>
